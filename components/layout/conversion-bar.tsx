  ...
  return (
    <>
      <a
        ...
        className="hidden lg:flex fixed bottom-6 right-6 z-40 h-14 w-14 items-center justify-center rounded-full bg-[var(--color-accent)] text-white shadow-[var(--shadow-lg)] transition-transform duration-[260ms] ease-[var(--ease)] hover:scale-105 hover:bg-[var(--color-accent-dark)]"
      >
        {whatsappIcon}
      </a>
